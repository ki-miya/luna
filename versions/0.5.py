import discord										#Luna v0.5
import asyncio										#12/12/2017
...
async def on_message(message):
	...
	if message.content.startswith('+testembed'):
		em = discord.Embed(title='Test title.', description='Test content', colour=0xFFC9EE)
		em.set_author(name='Test author', icon_url=client.user.default_avatar_url)
